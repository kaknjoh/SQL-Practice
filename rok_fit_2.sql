...
CREATE PROCEDURE proc_lozinka_up 
as
begin 
update produkt
set REVERSE (right (mj_jedinica,4) + dobavljac_post_br)
select * from produkt
where try_convert(int, dobavljac_post_br) is not null
...
*/
select * from produkt where produktID between 1 and 10
--a
